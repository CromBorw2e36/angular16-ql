...
@Component({
  selector: 'app-system-menu-settings-edit',
  templateUrl: './system-menu-settings-edit.component.html',
  styleUrls: ['./system-menu-settings-edit.component.scss']
})
export class SystemMenuSettingsEditComponent extends LayoutComponentBase implements OnInit, IVoucher_Form_UI, IToolBarComponent {
  ...
  @Input() dataFilter: SysMenu = new SysMenu();
