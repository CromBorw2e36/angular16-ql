...
export class VoucherFormColumnSettingsEditComponent extends LayoutComponentBase implements OnInit, IVoucher_Form_UI, IToolBarComponent {
  ...
  // table_name: string = 'SysVoucherFormColumn';
