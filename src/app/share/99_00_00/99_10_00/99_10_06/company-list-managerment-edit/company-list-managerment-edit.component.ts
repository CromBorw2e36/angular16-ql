...
@Component({
  selector: 'app-company-list-managerment-edit',
  templateUrl: './company-list-managerment-edit.component.html',
  styleUrls: ['./company-list-managerment-edit.component.scss']
})
export class CompanyListManagermentEditComponent  extends LayoutComponentBase {
