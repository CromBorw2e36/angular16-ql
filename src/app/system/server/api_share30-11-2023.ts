...
export class SysMenusClient extends APIBase implements ISysMenusClient {
    ...
    postSysMenu(sysMenu: SysMenu, httpContext?: HttpContext): Observable<SysMenu[]> {
    ...
    protected processPostSysMenu(response: HttpResponseBase): Observable<SysMenu[]> {
    ...
    deleteSysMenu(id: string, httpContext?: HttpContext): Observable<FileResponse> {
    ...
    protected processDeleteSysMenu(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class CurrentJobPositionsClient extends APIBase implements ICurrentJobPositionsClient {
    ...
    getCurrentJobPositions(httpContext?: HttpContext): Observable<CurrentJobPosition[]> {
    ...
    postCurrentJobPosition(currentJobPosition: CurrentJobPosition, httpContext?: HttpContext): Observable<CurrentJobPosition> {
        let url_ = this.baseUrl + "/api/CurrentJobPositions";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getCurrentJobPosition(id: string, httpContext?: HttpContext): Observable<CurrentJobPosition> {
    ...
    putCurrentJobPosition(id: string, currentJobPosition: CurrentJobPosition, httpContext?: HttpContext): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/CurrentJobPositions/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    deleteCurrentJobPosition(id: string, httpContext?: HttpContext): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/CurrentJobPositions/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
...
export class SalaryAndBenefitsClient extends APIBase implements ISalaryAndBenefitsClient {
    ...
    getSalaryAndBenefitsAll(httpContext?: HttpContext): Observable<SalaryAndBenefits[]> {
    ...
    postSalaryAndBenefits(salaryAndBenefits: SalaryAndBenefits, httpContext?: HttpContext): Observable<SalaryAndBenefits> {
        let url_ = this.baseUrl + "/api/SalaryAndBenefits";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getSalaryAndBenefits(id: string, httpContext?: HttpContext): Observable<SalaryAndBenefits> {
    ...
    putSalaryAndBenefits(id: string, salaryAndBenefits: SalaryAndBenefits, httpContext?: HttpContext): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/SalaryAndBenefits/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    deleteSalaryAndBenefits(id: string, httpContext?: HttpContext): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/SalaryAndBenefits/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
...
export class WorkHistoriesClient extends APIBase implements IWorkHistoriesClient {
    ...
    postWorkHistory(workHistory: WorkHistory, httpContext?: HttpContext): Observable<WorkHistory> {
        let url_ = this.baseUrl + "/api/WorkHistories";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getWorkHistory(id: string, httpContext?: HttpContext): Observable<WorkHistory> {
    ...
    putWorkHistory(id: string, workHistory: WorkHistory, httpContext?: HttpContext): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/WorkHistories/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    deleteWorkHistory(id: string, httpContext?: HttpContext): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/WorkHistories/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
...
export class AccountsClient extends APIBase implements IAccountsClient {
    ...
    login(account: Account, httpContext?: HttpContext): Observable<StatusMessage> {
    ...
    postAccount(account: Account, httpContext?: HttpContext): Observable<StatusMessage> {
    ...
    updateAccount(account: Account, httpContext?: HttpContext): Observable<StatusMessage> {
    ...
    deleteAccount(id: string, httpContext?: HttpContext): Observable<StatusMessage> {
...
export class UserInfoesClient extends APIBase implements IUserInfoesClient {
    ...
    addUser(userInfo: UserInfo, httpContext?: HttpContext): Observable<StatusMessage> {
    ...
    updUser(userInfo: UserInfo, httpContext?: HttpContext): Observable<StatusMessage> {
    ...
    deleteUserInfo(id: string, httpContext?: HttpContext): Observable<FileResponse> {
