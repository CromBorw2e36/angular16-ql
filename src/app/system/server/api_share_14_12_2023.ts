...
export interface ISysMenusClient {
  postSysMenu(sysMenu: SysMenu): Observable<SysMenu[]>;
  deleteSysMenu(id: string): Observable<FileResponse>;
}
@Injectable()
...
export class SysMenusClient extends APIBase implements ISysMenusClient {
  ...
  postSysMenu(
    ...
    let url_ = this.baseUrl + '/api/SysMenus/Get';
    url_ = url_.replace(/[?&]$/, '');

    const content_ = JSON.stringify(sysMenu);
    ...
    return _observableFrom(this.transformOptions(options_))
      ...
      .pipe(
        _observableMergeMap((response_: any) => {
          return this.processPostSysMenu(response_);
        })
      )
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              return this.processPostSysMenu(response_ as any);
            } catch (e) {
  ...
  deleteSysMenu(
    ...
    let url_ = this.baseUrl + '/api/SysMenus/{id}';
    ...
    return _observableFrom(this.transformOptions(options_))
      ...
      .pipe(
        _observableMergeMap((response_: any) => {
          return this.processDeleteSysMenu(response_);
        })
      )
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              return this.processDeleteSysMenu(response_ as any);
            } catch (e) {
  ...
  protected processDeleteSysMenu(
    response: HttpResponseBase
  ): Observable<FileResponse> {
    const status = response.status;
    const responseBlob =
...
@Injectable()
export class CurrentJobPositionsClient
  extends APIBase
  implements ICurrentJobPositionsClient
{
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
  ...
  protected processGetCurrentJobPositions(
    response: HttpResponseBase
  ): Observable<CurrentJobPosition[]> {
    const status = response.status;
    const responseBlob =
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<CurrentJobPosition>;
            }
          } else
            return _observableThrow(
              response_
  ...
  protected processPostCurrentJobPosition(
    response: HttpResponseBase
  ): Observable<CurrentJobPosition> {
    const status = response.status;
    const responseBlob =
  ...
  protected processGetCurrentJobPosition(
    response: HttpResponseBase
  ): Observable<CurrentJobPosition> {
    const status = response.status;
    const responseBlob =
  ...
  protected processPutCurrentJobPosition(
    response: HttpResponseBase
  ): Observable<FileResponse> {
    const status = response.status;
    const responseBlob =
  ...
  protected processDeleteCurrentJobPosition(
    response: HttpResponseBase
  ): Observable<FileResponse> {
    const status = response.status;
    const responseBlob =
...
@Injectable()
export class SalaryAndBenefitsClient
  extends APIBase
  implements ISalaryAndBenefitsClient
{
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
  ...
  protected processGetSalaryAndBenefitsAll(
    response: HttpResponseBase
  ): Observable<SalaryAndBenefits[]> {
    const status = response.status;
    const responseBlob =
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<SalaryAndBenefits>;
            }
          } else
            return _observableThrow(
              response_
  ...
  protected processPostSalaryAndBenefits(
    response: HttpResponseBase
  ): Observable<SalaryAndBenefits> {
    const status = response.status;
    const responseBlob =
  ...
  protected processGetSalaryAndBenefits(
    response: HttpResponseBase
  ): Observable<SalaryAndBenefits> {
    const status = response.status;
    const responseBlob =
  ...
  protected processPutSalaryAndBenefits(
    response: HttpResponseBase
  ): Observable<FileResponse> {
    const status = response.status;
    const responseBlob =
  ...
  protected processDeleteSalaryAndBenefits(
    response: HttpResponseBase
  ): Observable<FileResponse> {
    const status = response.status;
    const responseBlob =
...
@Injectable()
export class WorkHistoriesClient
  extends APIBase
  implements IWorkHistoriesClient
{
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
  ...
  getWorkHistories(httpContext?: HttpContext): Observable<WorkHistory[]> {
  ...
  protected processGetWorkHistories(
    response: HttpResponseBase
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<WorkHistory>;
        })
      );
  }

  protected processPostWorkHistory(
    response: HttpResponseBase
  ): Observable<WorkHistory> {
    const status = response.status;
    const responseBlob =
  ...
  protected processGetWorkHistory(
    response: HttpResponseBase
  ): Observable<WorkHistory> {
    const status = response.status;
    const responseBlob =
  ...
  protected processPutWorkHistory(
    response: HttpResponseBase
  ): Observable<FileResponse> {
    const status = response.status;
    const responseBlob =
  ...
  protected processDeleteWorkHistory(
    response: HttpResponseBase
  ): Observable<FileResponse> {
    const status = response.status;
    const responseBlob =
...
export class AccountsClient extends APIBase implements IAccountsClient {
    ...
    return _observableFrom(this.transformOptions(options_))
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              return this.processCheckTheExpirationDateOfToken(
                response_ as any
              );
            } catch (e) {
  ...
  protected processCheckTheExpirationDateOfToken(
    response: HttpResponseBase
  ): Observable<boolean> {
    const status = response.status;
    const responseBlob =
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<StatusMessage>;
        })
      );
  }
  ...
  protected processUpdateAccount(
    response: HttpResponseBase
  ): Observable<StatusMessage> {
    const status = response.status;
    const responseBlob =
  ...
  protected processDeleteAccount(
    response: HttpResponseBase
  ): Observable<StatusMessage> {
    const status = response.status;
    const responseBlob =
...
@Injectable()
export class MenuPermissionsClient
  extends APIBase
  implements IMenuPermissionsClient
{
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
  ...
  getListMenu(httpContext?: HttpContext): Observable<SysMenu[]> {
...
export class UserInfoesClient extends APIBase implements IUserInfoesClient {
  ...
  getMyUser(httpContext?: HttpContext): Observable<UserInfo> {
  ...
  getLstUser(httpContext?: HttpContext): Observable<UserInfo[]> {
  ...
  protected processDeleteUserInfo(
    response: HttpResponseBase
  ): Observable<FileResponse> {
    const status = response.status;
    const responseBlob =
...
@Injectable()
export class CommonContronllerClient
  extends APIBase
  implements ICommonContronllerClient
{
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
  ...
  listCompany(httpContext?: HttpContext): Observable<Company[]> {
...
export class WorkHistory implements IWorkHistory {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.workHistoryStart = _data['workHistoryStart']
        ? new Date(_data['workHistoryStart'].toString())
        : <any>undefined;
      this.workHistoryEnd = _data['workHistoryEnd']
        ? new Date(_data['workHistoryEnd'].toString())
        : <any>undefined;
  ...
  toJSON(data?: any) {
    ...
    data['workHistoryStart'] = this.workHistoryStart
      ? this.workHistoryStart.toISOString()
      : <any>undefined;
    data['workHistoryEnd'] = this.workHistoryEnd
      ? this.workHistoryEnd.toISOString()
      : <any>undefined;
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.modifyDate = _data['modifyDate']
        ? new Date(_data['modifyDate'].toString())
        : <any>undefined;
